module("AckTestSendOk", package.seeall)


function new()
	local tab_obj = {}
	setmetatable(tab_obj, {__index = AckTestSendOk})
	tab_obj:init()
	return tab_obj
end
...
function encode(self)
	...
	local id_f32_count = table.getn(self.id_f32)
	...
	return pack:encode(Msg.P_ACK_TEST_SEND_OK)
end
