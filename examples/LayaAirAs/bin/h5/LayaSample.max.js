...
var LayaSample=(function(){
	...
	__proto.onNetOpen=function(){
		console.log('网络链接成功');
		this._netMgr.on(40050,this.onAckTestXX);
		this._netMgr.on(40020,this.onAckTestSendOk);
		this._netMgr.on(40090,this.onAckTestJsOk);
		var reqTestXX=new proto.ReqTestXX();
		reqTestXX.id_u8=111;
		...
		var reqTestJs=new proto.ReqTestJs();
		reqTestJs.u64=429496729610086;
		reqTestJs.i64=-429496729612233;
		this._netMgr.send(reqTestJs.Encode());
	}

	__proto.onNetClose=function(){}
	__proto.onNetError=function(){}
	__proto.onAckTestXX=function(packetId,packet){
		console.log('LayaSampel.as packetId:'+packetId);
		var ackTestXX=new proto.AckTestXX(packet);
		console.log('ackTestXX:',ackTestXX);
	}

	__proto.onAckTestSendOk=function(packetId,packet){
		console.log('LayaSampel.as packetId:'+packetId);
		var ackTestSendOk=new proto.AckTestSendOk(packet);
		console.log('ackTestSendOk:',ackTestSendOk);
	}

	__proto.onAckTestJsOk=function(packetId,packet){
		console.log('LayaSampel.as packetId:'+packetId);
		var ackTestJsOk=new proto.AckTestJsOk(packet);
...
//class manager.NetMgr
var NetMgr=(function(){
	function NetMgr(caller,onopen,onclose,onerror){
		this._host="";
		this._port=0;
		this._socket=null;
		this._handlers=null;
		this._handlerArr=null;
		this._bufferLen=0;
		this._buffer=null;
		this._caller=null;
		this._onopen=null;
	...
	__class(NetMgr,'manager.NetMgr');
	var __proto=NetMgr.prototype;
	//注册
	__proto.on=function(packetId,method){
		if (!this._handlers.get(packetId)){
			this._handlerArr=[];
			this._handlerArr.push(method);
			this._handlers.set(packetId,this._handlerArr);
		}
		else{
	...
	*
	*/
	__proto.off=function(packetId,method){
		if (!this._handlers.get(packetId)){
			...
			this._handlerArr=this._handlers.get(packetId);
			var _tempindex=-1;
			for (var j=0;j < this._handlerArr.length;j++){
				if (this._handlerArr[j]==method){
					_tempindex=j;
					break ;
				}
			}
			if(_tempindex >-1)
				this._handlerArr.splice(_tempindex,1);
		}
	}
	...
	*/
	...
	__proto.receiveHandler=function(msg){
		this.processRecive(msg);
	}

	__proto.processRecive=function(data){
	...
	__proto.send=function(packet){
		if (this.isConnect){
			var bf=packet.Buffer();
	...
	*
	*/
	__getset(0,__proto,'isConnect',function(){
...
//class proto.AckTestJsOk
var AckTestJsOk=(function(){
	function AckTestJsOk(packet){
		this._u64=NaN;
		this._i64=NaN;
		if (packet){
	...
	__class(AckTestJsOk,'proto.AckTestJsOk');
	var __proto=AckTestJsOk.prototype;
	__getset(0,__proto,'u64',function(){return this._u64;},function(value){this._u64=value;});
	__getset(0,__proto,'i64',function(){return this._i64;},function(value){this._i64=value;});
	return AckTestJsOk;
})()


//class proto.AckTestSendOk
var AckTestSendOk=(function(){
	function AckTestSendOk(packet){
		this._id_u8=0;
		this._role_base=null;
		this._id_f32=[];
		this.id_op_u8_flag=0;
		this._id_op_u8=0;
		this.op_role_base_flag=0;
		this._op_role_base=null;
		if (packet){
	...
	__class(AckTestSendOk,'proto.AckTestSendOk');
	var __proto=AckTestSendOk.prototype;
	__getset(0,__proto,'id_u8',function(){return this._id_u8;},function(value){this._id_u8=value;});
	__getset(0,__proto,'role_base',function(){return this._role_base;},function(value){this._role_base=value;});
	__getset(0,__proto,'id_f32',function(){return this._id_f32;},function(value){this._id_f32=value;});
	__getset(0,__proto,'id_op_u8',function(){return this._id_op_u8;},function(value){this.id_op_u8_flag=1;this._id_op_u8=value;});
	__getset(0,__proto,'op_role_base',function(){return this._op_role_base;},function(value){this.op_role_base_flag=1;this._op_role_base=value;});
	return AckTestSendOk;
})()


//class proto.AckTestXX
var AckTestXX=(function(){
	function AckTestXX(packet){
		this._id_u8=0;
		this._id_u16=0;
		this._id_u32=0;
		this._repeat_id_u8=[];
		this.optional_id_u8_flag=0;
		this._optional_id_u8=0;
		if (packet){
			this._id_u8=packet.ReadByte();
	...
	__class(AckTestXX,'proto.AckTestXX');
	var __proto=AckTestXX.prototype;
	__getset(0,__proto,'id_u8',function(){return this._id_u8;},function(value){this._id_u8=value;});
	__getset(0,__proto,'id_u16',function(){return this._id_u16;},function(value){this._id_u16=value;});
	__getset(0,__proto,'id_u32',function(){return this._id_u32;},function(value){this._id_u32=value;});
	__getset(0,__proto,'repeat_id_u8',function(){return this._repeat_id_u8;},function(value){this._repeat_id_u8=value;});
	__getset(0,__proto,'optional_id_u8',function(){return this._optional_id_u8;},function(value){this.optional_id_u8_flag=1;this._optional_id_u8=value;});
	return AckTestXX;
})()
...
var Msg=(function(){
	function Msg(){}
	__class(Msg,'proto.Msg');
	Msg.ACK_CHAT_SEND_OK=1520;
	Msg.ACK_ROLE_RAND_NAME_OK=1040;
	Msg.ACK_ROLE_LOGIN_OK=1050;
	Msg.ACK_ROLE_LOGIN_OK_NO_ROLE=1060;
	Msg.ACK_SCENE_ENTER=2040;
	Msg.ACK_SCENE_PLAYERS=2050;
	Msg.ACK_SCENE_EXIT=2060;
	Msg.ACK_SCENE_MOVE=2080;
	Msg.ACK_TEST_SEND_OK=40020;
	Msg.ACK_TEST_X_X=40050;
	Msg.ACK_TEST_PHP_OK=40070;
	Msg.ACK_TEST_JS_OK=40090;
	return Msg;
})()


//class proto.MsgRoleBase
var MsgRoleBase=(function(){
	function MsgRoleBase(packet){
		this._uid=0;
		this._uname=null;
		if (packet){
	...
	__class(MsgRoleBase,'proto.MsgRoleBase');
	var __proto=MsgRoleBase.prototype;
	__proto.Encode=function(){
	...
	__getset(0,__proto,'uid',function(){return this._uid;},function(value){this._uid=value;});
	__getset(0,__proto,'uname',function(){return this._uname;},function(value){this._uname=value;});
	return MsgRoleBase;
})()
...
var Packet=(function(){
	function Packet(buffer){
		...
		this._byte.pos=0;
		this._byte.endian="bigEndian";
	}

	__class(Packet,'proto.Packet');
	...
	__proto.WriteBuffer=function(v){
	...
	__proto.WriteSbyte=function(v){
		this._byte.writeUint8(v);
	}

	__proto.WriteUshort=function(v){
		this._byte.writeUint16(v);
	}

	__proto.WriteShort=function(v){
		this._byte.writeInt16(v);
	}

	__proto.WriteUint=function(v){
	...
	//Int64转换成ByteArray
	__proto.writeInt64=function(bigInt){
		var zeros="00000000";
	...
	//ByteArray转换成Int64
	__proto.readInt64=function(bytes){
		var zeros="00000000";
		var s=bytes.readUnsignedInt().toString(16);
		var str=zeros.substr(0,8-s.length)+s;
...
//class proto.ReqTestJs
var ReqTestJs=(function(){
	function ReqTestJs(){
		this._u64=NaN;
		this._i64=NaN;
	}

	__class(ReqTestJs,'proto.ReqTestJs');
	var __proto=ReqTestJs.prototype;
	__proto.Encode=function(){
		var packet=new Packet();
...
var ReqTestSend=(function(){
	...
	__class(ReqTestSend,'proto.ReqTestSend');
	var __proto=ReqTestSend.prototype;
	__proto.Encode=function(){
		var packet=new Packet();
...
var ReqTestXX=(function(){
	...
	__class(ReqTestXX,'proto.ReqTestXX');
	var __proto=ReqTestXX.prototype;
	__proto.Encode=function(){
		var packet=new Packet();
		packet.WriteByte(this._id_u8);
